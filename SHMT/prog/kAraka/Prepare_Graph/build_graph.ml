  ...
  [ Wif (id2,mid2,_,rt2,_,_,upasarga2,sanAxiH2,prayogaH2,_,puruRaH2,vacanam2,_,_,_,_) ->
     ...
     | Sup (id1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
       ...
       [ 1 ->  if aBihiwa rt1 vacanam1 vacanam2 puruRaH2
           ...
           [ "karwari" -> if rt1="pUrvaka" && compound word1 uwwarapaxa1 && lifgam1="napuM"
                            ...
                            then [ Relation (id1,mid1,"prayojanam",id2,mid2,"1.30c")]
                 ...
                 | _ -> match sanAxiH2 with
                    ["Nic" ->  match verb_type rt2 upasarga2 with
                           ...
                           | "sakarmaka"  -> [ Relation (id1,mid1,"prayojyakarwA",id2,mid2,"1.8")]  
                                 (* aBihiwe praWamA  -yajFaxawwena  xevaxawwaH  PalaM  KAxyawe *)
                           | _ -> []
                           ]
    ...
    | 2 -> match prayogaH2 with
           ["karwari" ->  match sanAxiH2 with
                ...
                | _ -> if    not (member_of (word1 ^ " " ^ string_of_int viBakwiH1) kriyAviSeRaNas) 
                      ...
                      [ "xvikarmaka1" 
                      | "xvikarmaka2" -> if rt1="pUrvaka" && compound word1 uwwarapaxa1 && lifgam1="napuM"
                                         then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.28a")]
                                         else if (pUrvapaxa1="sa") && lifgam1="napuM"
                                         then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.29a")]
                                         else if rt1="arWa" && compound word1 uwwarapaxa1
                                         then [ Relation (id1,mid1,"prayojanam",id2,mid2,"1.30a")]
       ...
       then match kqw2 with
         [ "kwa" -> if not (viBakwiH2 = 7) 
                ...
                [ 1 -> if    noun_agreement vacanam1 vacanam2 lifgam1 lifgam2
                   ...
                   then if rt1="pUrvaka" && compound word1 uwwarapaxa1 && lifgam1="napuM"
                        then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.28d")]
                        else if (pUrvapaxa1="sa") && lifgam1="napuM"
                        then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.29d")]
                        else if rt1="arWa" && compound word1 uwwarapaxa1
                        then [ Relation (id1,mid1,"prayojanam",id2,mid2,"1.30d")]
...
Counter example: sarva-BUwa-hiwe rawAH *)
        ...
        | "Sawq_lqt" ->  if not (viBakwiH2 = 7) 
                         ...
                         else if viBakwiH1=2 && (members_of rt2 upasarga2 sakarmaka_verbs || members_of rt2 upasarga2 xvikarmaka1 || members_of rt2 upasarga2 xvikarmaka2) && not (uwwarapaxa1="pUrvaka")
                         then [ Relation (id1,mid1,"karma",id2,mid2,"2.17")] 
			 else []
			 else []
        | "wqc" 
        | "Nvul"  -> if viBakwiH1=2 && (members_of rt2 upasarga2 sakarmaka_verbs || members_of rt2 upasarga2 xvikarmaka1 || members_of rt2 upasarga2 xvikarmaka2) && not (uwwarapaxa1="pUrvaka")
                         then [ Relation (id1,mid1,"karma",id2,mid2,"2.17")] 
                         else if rt1="arWa" && compound word1 uwwarapaxa1
                         then [ Relation (id1,mid1,"prayojanam",id2,mid2,"2.18")]
                         else if rt1="pUrvaka" && compound word1 uwwarapaxa1 && lifgam1="napuM"
	...
	| "lyut" -> if viBakwiH1=3
                    ...
                    else if viBakwiH1=6 && (members_of rt2 upasarga2 sakarmaka_verbs) && (pUrvapaxa2=uwwarapaxa1 || pUrvapaxa1="a") && not (uwwarapaxa1="pUrvaka")
       ...
       | 4 ->  if (no_boundary_crossing id1 id2)
               then if members_of rt2 upasarga2 sampraxAna_verbs
                    then [ Relation (id1,mid1,"sampraxAnam",id2,mid2,"3.8") ] (*cawurWI sampraxAne 2-3-13  viprAya xaxAwi *) 
                         ...
                         then [ Relation (id1,mid1,"karma",id2,mid2,"3.8") ] 
...
if (not (lifgam1="napuM") && kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="ac" || kqw_prawyayaH2="yaw") && (viBakwiH2=1) && id2 = total_wrds.val  *)
       ...
       | 2  -> (* covered in rlwifkarwA_karma and rlkqwkarwA_karma *)
           ...
           then [ Relation (id1,mid1,"awyanwasaMyoga_sambanXa",id2,mid2,"3.26")] (* xevaxawwaH mAsam pATam aXIwe kAlAXvanorawyanwasaMyoge A 2.3.5 *)  (* yogyawA *)
           else if member_of (uwwarapaxa1^" "^string_of_int viBakwiH1) kriyAviSeRaNas (* yogyawA *) && lifgam1="napuM"
...
value rlafgavikAra m1 m2 text_type = match m2 with
   ...
   | WaxXiwa (id2,mid2,_,rt2,_,_,_,_,_,_,_,_) -> 
      ...
      | WaxXiwa (id1,mid1,_,rt1,_,_,_,_,_,viBakwiH1,_,_) ->
       ...
       then match viBakwiH1 with
       [ 3 -> [ Relation (id1,mid1,"afgavikAra",id2,mid2,"7.1a")] 
       | _ -> []
       ] 
       else []
      | _ -> []
...
|| (pronominal123 rt1 && not (viBakwiH1 = 6)))
...
We can have vyAkulaH saH, and also ye janAH ...*)
       ...
       then [ Relation (id2,mid2,"viSeRaNam",id1,mid1,"12.1")]
       else []
       else [ Relation (id1,mid1,"viSeRaNam",id2,mid2,"12.1a")]
       else []
       else []
     ...
     | Kqw (id1,mid1,_,_,_,_,kqw_prawyayaH1,_,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
       ...
       && not (kqw_prawyayaH1="GaF") 
       && not (member_of (word2^" "^string_of_int viBakwiH2) kriyAviSeRaNas) (* Why is this cond? *)
       && not(rt1=rt2) && not(rt2="kim") && (no_boundary_crossing id1 id2)
...
value rlupapaxa m1 m2 text_type = match m2 with
   ...
   | WaxXiwa (id2,mid2,word2,rt2,_,_,_,_,_,_,_,_) ->
      match m1 with
      ...
      | WaxXiwa (id1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,viBakwiH1,_,_) ->
         ...
         [ 2  -> match word2 with
                 ...
                 | "hA" | "Xik" ->
                    [Relation (id1,mid1,"uxgAravAcaka",id2,mid2,"17.2")]
                 | "prawi" ->
                    [ Relation (id1,mid1,"upa_ABimuKya",id2,mid2,"17.3")
                    ; Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.4")
                    ]
                 | "aBi" | "anu" (* |"api"   Discuss with Sanjeev *) ->
                    [Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.5")]
		 | "anwarA" -> 
                    [Relation (id1,mid1,"upa_apekRA",id2,mid2,"17.6")]
		 | "nAnA" | "pqWak" -> 
                    [Relation (id1,mid1,"upa_apekRA",id2,mid2,"17.7")]
		 | "uwwareNa" | "xakRiNena" | "aXareNa" -> 
                    [Relation (id1,mid1,"upa_apekRA",id2,mid2,"17.8")]
		 | "anwareNa" ->
                    [Relation (id1,mid1,"upa_sambanXa",id2,mid2,"17.9")]
		 | "vinA" ->
                    [Relation (id1,mid1,"upa_sambanXa",id2,mid2,"17.10")]
                 | _ -> []
                 ]
         | 3  -> match rt2 with
                 [ "nAnA" | "pqWak"  ->
                 ...
                 | "samA" ->
                    [Relation (id1,mid1,"samUha",id2,mid2,"17.13")]
                 | _ -> match word2 with
                    [ "alam" ->
                      [Relation (id1,mid1,"upa_prawisixXa",id2,mid2,"17.14")]
                    | "saha" | "sAkam" | "sArXam" | "samam" | "vinA" ->
                    [Relation (id1,mid1,"upa_sambanXa",id2,mid2,"17.15")]
                    | _ -> []
                    ]
                 ]
        | 4 -> match word2 with
		 [ "alam" | "praBuH" | "SakwaH"  ->
                    [Relation (id1,mid1,"upa_prayojanam",id2,mid2,"17.16a")]
                 ...
                 | "namaH" ->
                    [Relation (id1,mid1,"upa_karma",id2,mid2,"17.17")]
                 | _ -> []
                 ]
        | 5 -> match word2 with
                 ...
                 | "vinA" | "qwe" ->
                    [Relation (id1,mid1,"upa_sambanXa",id2,mid2,"17.19")]
                 | "apa" | "pari" | "prawi" ->
                    [Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.20")]
                 | "A" ->
                    [Relation (id1,mid1,"upa_apekRA",id2,mid2,"17.18")
                    ;Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.20")]
                 | "AraBya" | "praBqwi" ->
                    [Relation (id1,mid1,"upa_srowa",id2,mid2,"17.21")]
                 | _ -> match rt2 with
                     ...
                     | "anya" | "anyA" ->
                       [Relation (id1,mid1,"samUha",id2,mid2,"17.23")]
                     | _ -> []
                     ]
                 ]
        | 6 -> match word2 with
                 [ "aByASam" | "aByASena" | "aByASAw" | "aByASe" |
                   "agrawaH" | "anwaH" | "anwikam" | "anwikAw" | "anwikena" |
		 ...
		 | "AyuRyam" |"Baxram" | "ciraFjIviwam" |
                 ...
                 | _ -> match rt2 with
                   ...
                   | "sama" | "samA" ->
                       [Relation (id1,mid1,"samUha",id2,mid2,"17.27")]
                   | "prasUwA" ->
        ...
        | 7 -> match rt2 with
               ...
               | _ -> match word2 with
                      ...
                      | "aXi" | "upa" ->
                         [Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.33")]
                      | _ -> [] 
                      ]
               ]
        | _ -> []
     ...
     | AvywaxXiwa (id1,mid1,word1,rt1,_,_,waxXiwaprawyayaH1,_) ->
            ...
            then  [Relation (id1,mid1,"upa_karmapravacanIya",id2,mid2,"17.20")]
            else []
     | _ -> []
     ]
  |_ -> []
...
value rlupapaxa_other_rel m1 m2 text_type = match m1 with
  ...
  | WaxXiwa (id1,mid1,word1,rt1,_,_,_,_,_,viB1,_,_) ->
   if not (viB1=8) then
    match word1 with
       [ "aByASam" | "aByASAw" | "aByASe" | "aByASena" | "agrawaH" | 
         "anwikam" | "anwikAw" | "anwike" | "anwikena" | "ArAw" | 
         "prAFca" | "prawyaFca" | "prawyak" |
         "samIpam" | "samIpAw" | "samIpe" | "samIpena" | "uwwaram" | 
	 "uwware" | "viprakqRtam" | "viprakqRtAw" | 
         "viprakqRte" | "viprakqRtena" | "xakRiNam" | "xakRiNe" | 
         "xUram" | "xUrAw" | "xUre" | "xUreNa" ->
        match m2 with 
      ...
      | "uwwareNa" | "aXareNa" | "xakRiNena" | "xakRiNA" | "xakRiNAhi" | 
	"uwwarA" | "uwwarAhi" | "avaswAw" ->
        match m2 with 
         [ Wif (id2,mid2,_,rt2,_,_,upasarga2,_,_,_,_,_,_,_,_,_)
         | Kqw (id2,mid2,_,rt2,upasarga2,_,_,_,_,_,_,_,_,_,_,_,_)
         | Avykqw (id2,mid2,_,rt2,_,_,upasarga2,_,_,_,_,_) ->
      ...
      | "nikatam" | "nikatAw" | "nikate" | "nikatena" ->
        match m2 with 
         [ Wif (id2,mid2,_,_,_,_,_,_,_,_,_,_,_,_,_,_)
         | Kqw (id2,mid2,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_)
         | Avykqw (id2,mid2,_,_,_,_,_,_,_,_,_,_) ->
   ...
   | Avy (id1,mid1,word1,rt1,_,_,_) -> 
          ...
          |  "aBiwaH" | "anwaH" | "aXoXaH" | "aXoZXaH" | "aXyaXi" | "anwarA"|
  ...
  | WaxXiwa (id1,mid1,word1,rt1,_,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
    match word1 with
       [ "sAXu" | "prawIcI" | "hiwam" | "asAXu" |
         ...
         | WaxXiwa (id2,mid2,word2,rt2,_,_,_,_,lifgam2,viBakwiH2,vacanam2,_) ->
           if  id1 < id2  && (no_boundary_crossing id1 id2) 
           &&  noun_agreement_vibh vacanam1 vacanam2 lifgam1 lifgam2 viBakwiH1 viBakwiH2
          ...
          [ 6 -> match m2 with 
                 [ Kqw (id2,mid2,_,rt2,_,_,kqw2,_,_,_,_,pUrvapaxa2,uwwarapaxa2,_,viBakwiH2,_,_) -> if   prose_order id1 id2 text_type
                   then if no_boundary_crossing id1 id2
                       && (kqw2="GaF" || kqw2="wavyaw" || kqw2="wqc" || kqw2 = "kwin" || kqw2 = "kwa" ||  kqw2 = "SAnac_lat" || kqw2 = "SAnac_lqt" || kqw2 = "Sawq_lat" || kqw2 = "Sawq_lqt" || kqw2 = "ac" || kqw2 = "kwavawu" || kqw2="Nvul")
(* pawriNAm viruwena *)
                       && not (viBakwiH2 = 8)
...
value rlkarwqrahiwakarwqsamAnAXikaraNam m1 m2 text_type = match m1 with
    [ Sup (id1,mid1,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
    | Kqw (id1,mid1,_,rt1,_,_,_,_,_,_,_,_,_,lifgam1,viBakwiH1,vacanam1,_)
    | WaxXiwa (id1,mid1,_,rt1,_,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
        match m2 with
        [ Wif (id2,mid2,_,rt2,_,_,upasarga2,_,prayogaH2,lakAraH2,puruRaH2,vacanam2,_,_,_,_) ->
...
value rlkarwqsamAnAXikaraNam m1 m2 m3 text_type = match m2 with
    [ Sup (id2,mid2,_,rt2,pUrva2,uwwara2,lifgam2,viBakwiH2,vacanam2,_) ->
      match m1 with
      [ Sup (id1,mid1,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
...
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
      ...
      | Avy (id1,mid1,_,rt1,_,_,_) -> match m3 with
...
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
  ...
  | Avy (id2,mid2,_,rt2,_,_,_) -> match rt2 with
       [ "avaH" | "avaraswAw"| "avarawaH" | "avaswAw" | "aXaH"|
         "aXarAw" | "aXareNa" | "aXaswAw" | "paraswAw"| "parawaH"|
         "paScAw" | "puraH" | "puraswAw"| "purawaH"| "upari"|
         "upariRtAw"| "uwwarA"| "uwwarAhi"| "uwwarAw"| "uwwarawaH"|
...
(* || pronominal12 rt1 *)
              ...
              (* && id2-id1 <= 3 *)
            && viBakwiH1=1 && (no_boundary_crossing id2 id3)
           then if rt2 = "miWyA" || rt2 = "anyaWA"
           then [ Relation (id2,mid2,"karwqsamAnAXikaraNam",id3,mid3,"25.3b") ] 
           else [ Relation (id2,mid2,"karwqsamAnAXikaraNam_upa",id3,mid3,"25.3b") ] 
(* rel is marked with the verb and not with the karwA. This is to ensure that the parse is correct. 
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
           else []
          | Kqw (id3,mid3,_,rt3,upasarga3,_,_,_,_,_,_,_,_,_,_,_,_)
...
value rlkarmasamAnAXikaraNam m1 m2 m3 text_type = match m2 with
    ...
    | WaxXiwa (id2,mid2,_,rt2,_,_,_,_,gen2,viB2,vac2,_) ->
      match m1 with
      [ Sup (id1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,gen1,viB1,vac1,_)
      | Kqw (id1,mid1,word1,_,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,gen1,viB1,vac1,_)
      | WaxXiwa (id1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,gen1,viB1,vac1,_) ->
...
(* waxA AyojakAH neharUM sanwuRtaM kqwavanwaH *)
            then if rt1="pUrvaka" && compound word1 uwwarapaxa1 && gen1="napuM"
                 then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.28b")]
                 else if (pUrvapaxa1="sa") && gen1="napuM"
                 then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"1.29b")]
                 else if rt1="arWa" && compound word1 uwwarapaxa1
                 then [ Relation (id1,mid1,"prayojanam",id2,mid2,"1.30b")]
...
*)
value sent_beginning_connectives id1 mid1 id2 mid2 rt2 upasarga2 word1 =
	      if id1 = 1 &&  word1 = "api"
              && (no_boundary_crossing id1 id2)
...
value rlsent_beginning_connectives m1 m2 text_type = match m1 with
     [ Avy (id1,mid1,word1,_,_,_,_) -> match m2 with
         [ Wif (id2,mid2,_,rt2,_,_,upasarga2,_,_,_,_,_,_,_,_,_)  ->
           sent_beginning_connectives id1 mid1 id2 mid2 rt2 upasarga2 word1
          | Kqw (id2,mid2,_,rt2,upasarga2,_,kqw2,_,_,_,_,_,_,_,_,_,_) -> 
             if member_of kqw2 bhaavavaaci_kqw || kqw2="kwa" || kqw2 = "kwavawu" 
             then sent_beginning_connectives id1 mid1 id2 mid2 rt2 upasarga2 word1
             else []
          | _ -> []
          ]
     | _ -> []
    ...
    | Sup(id2,mid2,_,_,_,_,_,_,_,_)  -> match m1 with
      [ Avy (id1,mid1,word1,_,_,_,_) -> match word1 with
            ...
            | "vA" -> if id2 = previous id1
                      then if id1 = 2
                           then if word1 = "ca"
                                then [ Relation (id1,mid1,"ca_sambanXaH",id2,mid2,"47.1")
                                     ; Relation (id1,mid1,"sup_samuccayaxyowaka",id2,mid2,"47.1") 
                                     ]
                                else if word1 = "vA"
                                     then [ Relation (id1,mid1,"vA_sambanXaH",id2,mid2,"47.1")
                                          ; Relation (id1,mid1,"sup_anyawaraxyowaka",id2,mid2,"47.1") 
                                          ]
                                     else []
                            else if word1 = "ca"
                                 then [ Relation (id1,mid1,"ca_sambanXaH",id2,mid2,"47.1") ]
...
value rlca_samucciwa m1 m2 m3 text_type = match m2 with
     [ Avy (id2,mid2,_,word2,_,_,_) -> 
        ...
        then match m3 with
        [ Wif (id3,mid3,_,_,_,_,_,_,prayogaH3,lakAra3,puruRaH3,vacanam3,_,_,_,_) ->
           (* if id3 = next id2 then ; not necessary. e.g. rAmaH SAlAm gacCawip pATam ca paTawi*) 
             match m1 with
              ...
              && (no_boundary_crossing id1 id3)
                 (*&& (word3="ca" || word3="cEva" || (word3="waWA" && id3 < id2 && id3 > 1))&*)
              then if (( (word2="ca" || word2="cEva")  && ((id2 < id3) || (id2 = id3+1)) && (id1 < id2) && (id2 = id1+2))
                     || (word2="waWA" && id2 < id3 && id2 > 1 && yaWA_pos.val = 1000))
                 then
                 [ Relation (id3,mid3,"samucciwa",id1,mid1,"46.1")
                 ; Relation (id2,mid2,"samuccayaxyowaka",id3,mid3,"46.2")
                 ]
        ...
        | Avykqw (id3,mid3,_,_,_,_,_,_,kqw_prawyaya3,_,_,_) -> match m1 with
             [ Avykqw (id1,mid1,_,_,_,_,_,_,kqw_prawyaya1,_,_,_) ->
                 ...
                 then if (( (word2="ca" || word2="cEva")  && (id2 = next id3))
                     || (word2="waWA" && id2 < id3 && id2 > 1 && yaWA_pos.val = 1000))
                 then
                 [ Relation (id3,mid3,"samucciwa",id1,mid1,"46.3")
                 ; Relation (id2,mid2,"samuccayaxyowaka",id3,mid3,"46.4")
                 ]
        ...
        | WaxXiwa (id3,mid3,_,_,_,_,_,_,_,viBakwiH3,vacanam3,_) -> 
              match m1 with
              ...
              | Kqw (id1,mid1,word1,rt1,_,_,_,_,_,_,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 ...
                 then
                 [ Relation (id1,mid1,"sup_samucciwa",id3,mid3,"46.5")
                 ; Relation (id2,mid2,"sup_samuccayaxyowaka",id3,mid3,"46.6")
                 ]
                 (*else if id3 > id2 
        ...
        | Kqw (id3,mid3,_,_,_,_,kqw3,_,_,_,_,_,_,_,viBakwiH3,vacanam3,_) ->
              ...
              [ Kqw (id1,mid1,_,_,_,_,kqw1,_,_,_,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 ...
                 then
                 [ Relation (id3,mid3,"samucciwa",id1,mid1,"46.8")
                 ; Relation (id2,mid2,"samuccayaxyowaka",id3,mid3,"46.9")
                 ]
                 (* else if id3 > id2 
              ...
              | WaxXiwa (id1,mid1,word1,rt1,_,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 ...
                 then if (  ((word2="ca" || word2="cEva") && (id2 = next id3)) 
                     || (word2="waWA" && id2 < id3 && id2 > 1 && yaWA_pos.val = 1000))
                 then
                 [ Relation (id3,mid3,"samucciwa",id1,mid1,"46.10")
                 ; Relation (id2,mid2,"samuccayaxyowaka",id3,mid3,"46.11")
                 ]
                 else if (word2="vA") && (id2 = next id3)
                 then
