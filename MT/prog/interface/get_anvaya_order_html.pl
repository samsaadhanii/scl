   ...
   if ($fld == 1 || $fld > 2) {
      ...
      if($word == 1) {
        ...
        if($fld == 1) { # words
          ...
          #print "<a href=\"/",$CGIURL,"/$SCL_CGI/MT/prog/interface/call_parser_summary.cgi?filename=",$TFPATH,"\&amp;outscript=",$outscript,"&rel=''&sentnum=1&save=no&translate=no\"  onmouseover=\"Tip('<img src=/$SCL_CGI/MT/DEMO/tmp_",$fbn,"/1.svg >' ,FONTSIZE,'18pt',HEIGHT,0,WIDTH,0,STICKY,true,CLOSEBTN,true)\">\n";
          print "<a href=\"/",$CGIURL,"/$SCL_CGI/MT/prog/interface/call_parser_summary.cgi?filename=",$TFPATH,"\&amp;outscript=",$outscript,"&rel=''&sentnum=1&save=no&translate=no\"  onmouseover=\"Tip(",system("cat $SCL_CGI/MT/DEMO/tmp_$fbn/1.svg"),FONTSIZE,'18pt',HEIGHT,0,WIDTH,0,STICKY,true,CLOSEBTN,true)\">\n";
        }
