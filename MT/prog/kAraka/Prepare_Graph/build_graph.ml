...
value no_boundary_crossing_with_iwi id1 id2 text_type =
  if (id1 = iva_pos.val -1) || (id2 = iva_pos.val -1) then True
       ...
       (* &&  no_boundary_crossing_kwvA_lyap id1 id2 -- why do you need this?  *)
...
But in grAmam gawaH xevaxawwaH puswakaM paTawi, here xevaxawwa should not be marked as karwA of gawaH but gawaH is the viSeRaNa for xevaxawwaH *)
  [ Kqw (id2,cid2,mid2,word2,rt2,upasarga2,sanAxiH2,kqw2,_,_,_,pUrvapaxa2,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) ->
     ...
     | Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       if ((pUrvapaxa2="n") || (id1+1=id2))  (* word should not be related to the pUrvapaxa; if it is, then the word should be just before the compound as in  SApena aswaf-gamiwa-mahimA *)
                   ...
                   (* ; Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"2.2",d12) 
                    ...
                    (* else if  members_of rt2 upasarga2 karmasamAnAXikaraNa_verbs && uwwarapaxa2="n"
                         then [ Relation (id1,cid1,mid1,"karmasamAnAXikaraNam",id2,cid2,mid2,"3.5",d12)
                              ; Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"3.6",d12)]   -- Need examples;  evaM ukwaH HqRikeSaH gudAkeSena, here hqRikeSaH is marked as a muKyakarma/karmasamAnAXikaraNam of ukwaH, which is wrong. Hence commented till a convincing example is found *)
...
(* -- mayA sIwA xqRtA iwi saH nyavexayaw, final verb is present, and sIwA is karma for xqRtA : Solution -- Treat these as two different sentences with a full stop before iwi.
			   ...
			   In this sumiwrAnanxa-varXanaH is marked as karma of vinaya-sampannaH, which is wrong *)
                   ...
                   then [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"3.7a",d12)] -- changed to viSeRaNas with reverse direction as below -- Amba 27.12.2025 *)
                   else if  members_of rt2 upasarga2 xvikarmaka1   && uwwarapaxa2="n"
                   then [ Relation (id2,cid2,mid2,"viSeRaNam",id1,cid1,mid1,"3.7",d12)]
                   else if members_of rt2 upasarga2 xvikarmaka2  && uwwarapaxa2="n"
                   then [ Relation (id2,cid2,mid2,"viSeRaNam",id1,cid1,mid1,"3.7a",d12)]
                   else []
                   else []
                   else []
             ...
             | 2 -> let rel = handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
	             if (not (rel=[])) then rel 
                     else if (pUrvapaxa2="y") then rel (* word should not be related to the pUrvapaxa*)
...
Counter example: sarva-BUwa-hiwe rawAH *)
                     (*  in case of kwa, if the verb is sakarmaka, the karma will be ukwa. So we need not mark the karma; In case of gqXram nihawam xqRtvA rAGavaH Soka-sanwapwaH, note that nihawam is an adj of gqXram, and not that gqXram is an obj of nihawam 
                     else if members_of rt2 upasarga2 sakarmaka_verbs && (uwwarapaxa2 = "n")
...
value anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type =
   if ((pUrvapaxa1 = "y") || (pUrvapaxa2 = "y")) then []
   else
   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
   match viBakwiH1 with
       [ 3 -> if (rt2="yaj1")
...
e.g. saH prAwaH BramaNAya gacCawi -- Amruta   14 July 2020
             *)
                ...
                (* manyakarmaNyanAxare viBARAZprANiRu 2-3-17 ahaM wvAM wqNAya manye / aham wvA wqNAya manye *)
                   else if members_of rt2 upasarga2 gawyarWa_verbs (* saH grAmAya gacCawi *)
                        then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.3a" ,d12) ]
       ...
       | 5 -> if members_of rt2 upasarga2 apAxAna_verbs
		    ...
		    else if rt2="arh1" (* wasmAw vayam arhAH - is with ac suffix; This looks like an exceptional case *)
                    then [ Relation (id1,cid1,mid1,"kArya_xyowakaH",id2,cid2,mid2,"4.17b",d12)]  
		    else []
 ...
 ... gacCawi ... paTawi; here gacCawi is marked as aXikaraNa. To stop this, again this is uncommented. 26th May 2018 *)
       ...
       | 8 ->  match m2 with
           [ Wif (id2,cid2,mid2,_,rt2,_,_,upasarga2,sanAxiH2,_,lakAraH2,puruRaH2,_,_,_,_) -> 
            if ((id1 <= 2 && text_type = "Prose") || text_type = "Sloka")
            && kqw1=0 (* the word should not be a kqxanwa to be in samboXana ; this was over-generating in the case of upasafgamya abravIw; upasafgamya being marked as a samboXya *)
              then  if (uwwarapaxa1="y") then [ Relation (id1,cid1,mid1,"samboXyaH",id2,cid2,mid2,"4.34c",d12)]
             (* if ((lakAraH2="lot") && (puruRaH2="ma"))
              then [ Relation (id1,cid1,mid1,"samboXyaH",id2,cid2,mid2,"3.14",d12)]
              else [] *)
              else if ((rt1="brahma" || rt1 = "miwra") && not (lifgam1 = "napuM")) 
                   then [ Relation (id1,cid1,mid1,"samboXyaH",id2,cid2,mid2,"4.34a",d12)]
                   else if (member_of rt1 manuRyasaFjFAvAcI || member_of rt1 upAXi || member_of rt1 named_entity || member_of rt1 sambanXavAcI || rt1="mahoxaya" || rt1 = "mahoxayA" || rt1 = "mahABAga" || rt1 = "mahABAgA") 
 ...
 (* These conditions under-generate. In the case of manuRyasaFjFAvAcI, the list needs to be populated. But more importantly, we have various adjectives such as anaGa, etc which are used for samboXana.  But still it is aviable to us this condition, with words such as anaGa etc added to this list, rather than making the list open *)
              then [ Relation (id1,cid1,mid1,"samboXyaH",id2,cid2,mid2,"4.34b",d12)]
              else[]
              else []
...
if (not (lifgam1="napuM") && kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="ac" || kqw_prawyayaH2="yaw") && (viBakwiH2=1) && id2 = total_wrds.val  *)
       ...
       | 2  -> (* covered in rlwifkarwA_karma and rlkqwkarwA_karma *)
           ...
           then [ Relation (id1,cid1,mid1,"awyanwasaMyogaH",id2,cid2,mid2,"4.36",d12)] (* xevaxawwaH mAsam pATam aXIwe kAlAXvanorawyanwasaMyoge A 2.3.5 *)  (* yogyawA *)
...
value rlanaBihiwe m1 m2 text_type = match m2 with
  [ Wif (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,upasarga2,_,_,_,_,_,_,_,_) ->
     ...
     [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_) ->
       if prose_order id1 id2 text_type
        &&  (no_boundary_crossing_with_iwi id1 id2 text_type || viBakwiH1 = 8)
...
Why this condition of 3 & 5 and hewu? We should write this in anaBihiwe itself!
     ...
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
           ...
           then if members_of rt2 upasarga2 apAxAna_verbs
                then [ Relation (id1,cid1,mid1,"apAxAnam",id2,cid2,mid2,"4.39a",d12)
                     ; Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.39b",d12) ]
		else [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.39c",d12) ]
	   else []
     | _ -> []
     ]
  | Avykqw (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,upasarga2,_,_,_,_) -> 
	 ...
	 then if  ((kqw1 ="Sawq_lat") || (kqw1 = "kwa")) (* In these cases, the kqxanwas can be kaarakas *)
       (*then if (* kqw1="wqc" && *) (viBakwiH1=3 || viBakwiH1 = 5)
Why this condition of 3 & 5 and hewu? We should write this in anaBihiwe itself!
       then [ Relation (id1,cid1,mid1,"hewuH",id2,cid2,mid2,"4.40",d12)] 
       else *) 
       then let kqw1=0 in let kqw2=1 in anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type
     ...
     | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,waxXiwa_prawyayaH1,lifgam1,viBakwiH1,_,_) -> 
       ...
       if prose_order id1 id2 text_type
         &&  ( no_boundary_crossing_with_iwi id1 id2 text_type || viBakwiH1 = 8)
       then if  waxXiwa_prawyayaH1="wva" && viBakwiH1=5
       then [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.41",d12)] 
     ...
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
           if ((word1 = "yawaH") || (word1 = "wawaH")) 
           then if members_of rt2 upasarga2 apAxAna_verbs
                then [ Relation (id1,cid1,mid1,"apAxAnam",id2,cid2,mid2,"4.42a",d12)
                     ; Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.42b",d12) ]
		else [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.42c",d12) ]
	   else []
     | _ -> []
     ]
        ...
        [ 2 -> if not (member_of word1 kAlAXvas)
	       ...
	       if (not (rel=[])) then rel 
              ...
              | "prawyavasAnArWa" -> if not (sanAxiH2="Nic")
                                     ...
                                     else if member_of rt1 animate_nouns || member_of rt1 manuRyasaFjFAvAcI || rt1="asmax" || rt1 = "yuRmax"
...
value rlAvy_kriyAviSeRaNam_or_aXikaraNam m1 m2 text_type = match m2 with
  ...
  | Avykqw (id2,cid2,mid2,word2,_,pUrvapaxa2,uwwarapaxa2,_,_,_,_,_) -> 
     ...
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       if prose_order id1 id2 text_type 
       then if (word1="svar") && (word2="gawaH")  (* fixed for svar gawaH ca saH - from Sankshepa RamayaNam *)
  ...
  | Kqw (id2,cid2,mid2,word2,_,_,_,kqw_prawyaya2,_,_,pUrvapaxa2,uwwarapaxa2,_,_,viBakwiH2,_,_)   ->
     if  pUrvapaxa2="y" || uwwarapaxa2="y" then []
     else if kqw_prawyaya2 ="kwa" || kqw_prawyaya2 ="kwavawu" || kqw_prawyaya2 = "yaw" || kqw_prawyaya2 = "lyut" || kqw_prawyaya2 = "wavyaw" || kqw_prawyaya2 = "anIyar"
    (* kaWam waw jFeyam ? *)
     then match m1 with
     [ Avykqw (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_,_,_,_,_)
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       if prose_order id1 id2 text_type 
       then if (viBakwiH2 = 7) && ( id1 > id2) then [] 
   ...
   | WaxXiwa (id2,cid2,mid2,_,rt2,_,_,_,_,_,_,_) -> 
      ...
      | WaxXiwa (id1,cid1,mid1,_,_,_,_,_,_,viBakwiH1,_,_) ->
          ...
          [ 7 -> if member_of rt2 viRayAXikaraNa_nouns
                 then [ Relation (id1,cid1,mid1,"viRayAXikaraNam",id2,cid2,mid2,"9.9",d12)] 
                 else []
          | _ -> []
          ]
          else []
   ...
   match m1 with
      [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
	      ...
	      && (not ((rt1 = "ananwaram" || word1 = "sahiwaH" || rt1 = "saxqSa" || rt1 = "saFjASa" || rt1 = "pramuKa" || word1 = "pUrveNa") && (uwwarapaxa1 = "y")))  
           then if ( member_of rt1 saMKyeya || member_of rt1 pUraNa || member_of rt1 kqxanwas || member_of rt1 taddhitaantas || member_of rt1 guNavacana  ||member_of rt1 sambanXavAcI
...
(* pronominal12 rt is added to allow a viSeRaNa for asmax such as prapaSxBiH asmaxBiH -- SBG 1.39 *)
		...
		&& not (rt2 = "kim")
                && not (member_of rt2 sambanXavAcI) 
                && not (member_of rt2 upAXi) 
		...
		(* && not (member_of rt2 intensifiers_list) -- awIva can be a viSeRaNa; awIva XanaM aswi *)
		   (* && not (pronoun3 rt2)  && member_of rt1 upAXi; pronoun is always preferred as a viSeRya in the absence of a  prANisaFjFAvAci Sabxa *)
               then if pronoun3 rt1 && uwwarapaxa2="y"
	            then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1b",d12)]
	                 ...
	                 then [ Relation (id2,cid2,mid2,"viSeRaNam",id1,cid1,mid1,"17.1a",d12)]
                              ...
                              then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1c",d12)]
	                      else if rt1="arWa"  && uwwarapaxa1 = "y" 
                                   then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1d",d12)] 
              ...
              else if (((member_of rt1 sambanXavAcI) || (member_of rt1 upAXi)) && (member_of rt2 manuRyasaFjFAvAcI || member_of rt2 named_entity || (rt2="samuxra" && rt1="pawi") || (rt1="kAraka" && rt2="xoRa")))
...
gacCan bAlakaH wqNam spqSawi / bAlakaH gacCan wqNam spqSawi *)
       ...
       then if (member_of rt1 sambanXavAcI)
            then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.6a",d12)]
            else if (kqw_prawyayaH1="Sawq_lat") && (viBakwiH1 > 1 && viBakwiH1 < 7) (* vasawi papmAwIre rAmaH; with viBakwiH1=7, vasawi would become an adj of pampAwIre *)
 ...
 value rlviSeRaNam m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,word2,_,_,_,_,_,_,rt2,pUrvapaxa2,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) -> 
       ...
       [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
	      ...
	      then if rt2="yuRmax" 
                   then if (member_of rt1 sambanXavAcI) || (member_of rt1 upAXi)
                        then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.1a",d12)]
	                else [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1b",d12)]
                   else if (rt2="samuxra" && rt1="pawi")
                        then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.2",d12)]
                        else if ((member_of rt1 sambanXavAcI) || (member_of rt1 upAXi)) && ((member_of rt2 manuRyasaFjFAvAcI) || (member_of rt2 named_entity))
                        then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.2a",d12)]
                             ...
                             then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.3",d12)]
                                  ...
                                  else if member_of rt2 manuRyasaFjFAvAcI || member_of rt2 named_entity
                                       then if ((member_of rt1 sambanXavAcI) || (member_of rt1 upAXi))
                                            then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.5",d12)]
					    else if (member_of rt1 guNavacana)
                                            then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.6",d12)]
					    else []
	                               else if rt1="arWa"  && uwwarapaxa1 = "y" 
                                            then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.7",d12)] 
     ...
     | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,waxXiwa_prawyayaH1,lifgam1,viBakwiH1,vacanam1,_) -> if (member_of rt1 upAXi) then [] else
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       if prose_order id1 id2 text_type
       && not (finite_verb_in_sentence.val = 50 && karwqsamverbs.val = 50)
            && no_boundary_crossing_except_kwvA id1 id2 text_type
	...
	&& not (rt2 = "kim")
       ...
       else if (waxXiwa_prawyayaH1 = "mayat")
       then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.17",d12)]
       else []
     | Kqw (id1,cid1,mid1,_,_,_,_,kqw_prawyayaH1,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_) -> 
       (* if (member_of rt1 upAXi) then [] else *)
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
...
gacCan bAlakaH wqNam spqSawi / bAlakaH gacCan wqNam spqSawi *)
       ...
       then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.15",d12)]
         ...
         && not (kqw_prawyayaH1="wavyaw")
         && not (kqw_prawyayaH1="anIyar")
         && not ((member_of rt2 sambanXavAcI) || (member_of rt2 upAXi))
...
value rlavy_viSeRaNam m1 m2 text_type = match m2 with
  ...
  | WaxXiwa (id2,cid2,mid2,_,rt2,_,_,_,lifgam2,viBakwiH2,vacanam2,_) -> 
     ...
     [ Avy (id1,cid1,mid1,word1,_,pUrvapaxa1,uwwarapaxa1,_) ->
       ...
       else if id1 < id2 && member_of word1 intensifiers_list
       then [ Relation (id1,cid1,mid1,"wIvrawAxarSI",id2,cid2,mid2,"18.2a",d12)]
      ...
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
        ...
        | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,rt2,_,_,lifgam2,viBakwiH2,vacanam2,_) ->
           if  ((rt2 = (get_assoc rt1 nirXAraNa_list)) 
                 || ((rt2 = "kiFciw" || rt2="vara" || rt2="SreRTa" || rt2="uwwama" || rt2 = "uwwamA" || rt2 = "SreRTA" || rt2="praXAna" || rt2 = "praXAnA" (* || rt2="maXya" -- How can maXye be nirXAraNa? *)
                     || member_of (rt1^" "^rt2) amarakosha_jAwi
                     || member_of rt2 sambanXavAcI)  (* yogyawA *)
                    && ((lifgam1=lifgam2) || lifgam1 = "a")))
   ...
   | WaxXiwa (id2,cid2,mid2,word2,rt2,_,_,_,_,_,_,_) ->
      ...
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,_,viBakwiH1,_,_) ->
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
         if   (id1=previous id2 || id1 = id2-2 (* to handle 'rAmeNa ca saha *)
               || (id1=next id2  && text_type = "Sloka") || ((word2="hA" || word2 = "Xik") && id1=next id2) || ((word2="alam") && id1=next id2) || (id1= id2+2  && text_type = "Sloka")) (* namaH Bagavawe vAsuxevAya -- id1 = id2+2 *)
         then match viBakwiH1 with
         [ 2  -> match word2 with
		   ...
		   | "anwarA" | "uwwareNa" | "xakRiNena" | "aXareNa" -> 
                 ...
                 | "prawi" ->
                    ...
                    ; Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.4",d12)
                    ]
                 | "aBi" | "anu" (* |"api"   Discuss with Sanjeev *) ->
                    [Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.5",d12)]
		 | "praxakRiNam" -> 
                    [Relation (id1,cid1,mid1,"sanxarBa_binxuH",id2,cid2,mid2,"25.6",d12)]
                 | _ -> []
                 ]
         | 3  -> match rt2 with
        ...
        | 5 -> match word2 with
                 ...
                 | "apa" | "pari" | "prawi" ->
                    [Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.14",d12)]
                 | "A" ->
                    [Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.15",d12)]
                 | "AraBya" | "praBqwiH" ->
        ...
        | 7 -> match rt2 with
               ...
               | _ -> match word2 with
                     [ "aXi" | "upa" ->
                         [Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.27",d12)]
                      | _ -> [] 
                      ]
               ]
        | 8 -> if rt2="namaH" 
     ...
     | AvywaxXiwa (id1,cid1,mid1,word1,rt1,_,_,waxXiwaprawyayaH1,_) ->
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
            ...
            then  [Relation (id1,cid1,mid1,"karmapravacanIya_anviwam",id2,cid2,mid2,"25.29",d12)]
            else []
           ...
           "aBi" | "anu" | "apa" | (*"api" | -- removed, since it overgenerates. We need to allow this only after examining examples with api *)
            ...
            "upa"  ->
             ...
             | Avykqw (id2,cid2,mid2,_,_,_,_,_,_,_,_,_) ->
               let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
               if (id1 < id2) && no_boundary_crossing_with_iwi id1 id2 text_type
               then [ Relation (id1,cid1,mid1,"karmapravacanIyaH",id2,cid2,mid2,"26.4a",d12)] 
               else []
             | Avy (id2,cid2,mid2,word2,rt2,_,_,_)  ->
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                   if (word2 = "aswu") && (id1=id2-1)
                   then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"26.4b",d12)] 
		   else []
             |_ -> []
             ]
...
value rlRaRTIsambanXaH m1 m2 text_type = match m1 with
      [ Sup (id1,cid1,mid1,_,rt1,pUrvapaxa1,_,lifga1,viBakwiH1,vacana1,_)
      | Kqw (id1,cid1,mid1,_,rt1,pUrvapaxa1,_,_,_,_,_,_,_,lifga1,viBakwiH1,vacana1,_)
      | WaxXiwa (id1,cid1,mid1,_,rt1,pUrvapaxa1,_,_,lifga1,viBakwiH1,vacana1,_) ->
           if not (pUrvapaxa1="y") && viBakwiH1=6  (*&& (not (member_of rt1 guNavacana)  THIS is removed, since there can be an ellipsis of the viSeRya ||  rt1="xayA" || rt1 = "mAyA") *)
           then match m2 with 
		   ...
		   if   prose_order id1 id2 text_type
			...
			&& not (pronominal123 rt2)
                       then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.1",d12)]
                           ...
                           else if member_of rt2 viRayi_list || member_of rt1 sambanXavAcI
                 ...
                 | WaxXiwa (id2,cid2,mid2,word2,rt2,pUrvapaxa2,uwwarapaxa2,_,_,viBakwiH2,_,_) -> 
       		   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                   if     prose_order id1 id2 text_type (*&& not (uwwarapaxa2 = "y")*)
                       && not (pUrvapaxa2="y")
                          then if no_boundary_crossing_with_iwi id1 id2 text_type
                               && (not (member_of rt2 guNavacana) || (rt2="xayA") || (rt2 = "kqpA") || (rt2 = "karuNA") || (rt2 = "mAyA") || (rt2="guru") || (rt2 = "kqRNa")|| (rt2="priya")) (* saH mama priyaH aswi *)
				(* guru & kqRNa are both guNavacana as well as nouns in different meanings  -- as a noun, it can have a RaRTI sambanXa *)
			       && not (pronominal123 rt2)
                               then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.5",d12)]
                                    ...
                                    then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.5a",d12)]
                                         ...
                                         then if   member_of rt2 sambanXavAcI 
                                             ...
                                             then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.5a",d12)]
					     else if member_of rt1 sambanXavAcI || member_of rt2 viRayi_list 
                 ...
                 | AvywaxXiwa (id2,cid2,mid2,word2,_,pUrvapaxa2,_,_,_) ->
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                   if    prose_order id1 id2 text_type
                      && not (pUrvapaxa2="y")
                 ...
                 | Avy (id2,cid2,mid2,word2,_,pUrvapaxa2,_,_) ->
                       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                       if word2 = "nAma"
                       && not (pUrvapaxa2="y")
                       then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.11",d12)]
	...
	if (word1 = "san") then []
       ...
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
        ...
        [ Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,_,_,puruRaH3,vacanam3,_,_,_) ->
          if   viBakwiH1=viBakwiH2 && vacanam1 = vacanam2 && viBakwiH1 = 1 
               && ((rt1 = "jyowis" && rt2="agni")|| rt2 = "miwra" || (rt1="asmax" && rt2="prakASa"))
               && rt3="BU1" && upasarga3="X" (* to account for jyowiH agniH Bavawi.  saH mama miwram aswi  ahaM prakASaH na BavAmi*)
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4a",d12)  ]
          else if   (viBakwiH1=viBakwiH2 && viBakwiH1 = 1 && rt1 = "vexa" && rt2="pramANa" && rt3="as2" && upasarga3="X") (* to account for vexAH pramANam aswi *)
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4b",d12)  ]
          else if (not (vacanam1=vacanam2) && ((rt1="mAsa" && (rt2="xakRiNAyana" || rt2="uwwarAyaNa"))|| (rt2="xArA")))
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4c",d12)  ]
          else if    (aBihiwa rt1 vacanam1 vacanam3 puruRaH3 || aBihiwa rt2 vacanam2 vacanam3 puruRaH3)
...
(* || pronominal12 rt1 *)
           || (lifgam1=lifgam2 || rt1="miwra"))  (* aham prakAsaH na BavAmi *)
...
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
        else if (aBihiwa rt1 vacanam1 vacanam3 puruRaH3 || pronominal12 rt2)
	     && id1 < id2
             && viBakwiH1=1
             && viBakwiH2=1 
             &&  members_of rt3 upasarga3 karwqsamAnAXikaraNa_verbs
...
E.g. grAmasya aXareNa vanam aswi.*)
      ...
      | AvywaxXiwa (id1,cid1,mid1,word1,_,_,_,_,_) -> match m3 with
       ...
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
          ...
          | "nAma" -> if members_of rt3 upasarga3 karwqsamAnAXikaraNa_verbs then
                      [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.3a",d12) 
                      ; Relation (id1,cid1,mid1,"karwA_be_verbs",id3,cid3,mid3,"34.3b",d12) ]
		      else []
          |_ -> []
          ]
          else []
      ...
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
        ...
        [ Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,prayogaH3,_,puruRaH3,vacanam3,_,_,_) ->
          if   (viBakwiH1=viBakwiH2 && vacanam1 = vacanam2 && viBakwiH1 = 1 && rt1 = "jyowis" && rt2="agni" && rt3="BU1" && upasarga3="X") (* to account for jyowiH agniH Bavawi *)
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4a",d12)  ]
          else if   (viBakwiH1=viBakwiH2 && viBakwiH1 = 1 && rt1 = "vexa" && rt2="pramANa" && rt3="as2" && upasarga3="X") (* to account for vexAH pramANam aswi *)
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4b",d12)  ]
          else if ((vacanam1=vacanam2) || (rt1="mAsa" && (rt2="xakRiNAyana" || rt2="uwwarAyaNa"))|| (rt2="xArA"))
          then [ Relation (id2,cid2,mid2,"viXeya_viSeRaNam",id1,cid1,mid1,"34.4c",d12)  ]
	  else if aBihiwa rt1 vacanam1 vacanam3 puruRaH3
             && members_of rt3 upasarga3 karwqsamAnAXikaraNa_verbs
             && viBakwiH1=viBakwiH2 && prayogaH3 = "karwari"
           && ((noun_agreement_vibh vacanam1 vacanam2 lifgam1 lifgam2 viBakwiH1 viBakwiH2) || pronominal12 rt1 )
(* || pronominal12 rt1 *)
           && not (member_of rt1 saMKyeya) (* yogyawA *)
           (*&& not (member_of rt1 guNavacana) (* yogyawA *)*)
...
value discourse_rel1 m1 id2 cid2 mid2 text_type = match m1 with
     [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
       ...
       | "cexapi" 
       | "sannapi" -> [ Relation (id1,cid1,mid1,"vyaBicAra_xyowakaH",id2,cid2,mid2,"37.1a",d12)]

       | "yawaH" -> if (id1 < id2)
                    then [ Relation (id1,cid1,mid1,"kAraNa_xyowakaH",id2,cid2,mid2,"37.2",d12)]
                    else []
       | "wawaH"
       | "awaH" -> if (id1 < id2)
          then [ Relation (id1,cid1,mid1,"kArya_xyowakaH",id2,cid2,mid2,"37.3",d12)]
          else []
       | "yaxi" -> if (id1 < id2)
          then [ Relation (id1,cid1,mid1,"AvaSyakawA_xyowakaH",id2,cid2,mid2,"37.4",d12)]
          else []
...
value rlavy_wifkqw_special m1 m2 text_type = match m2 with
  [ Wif (id2,cid2,mid2,word2,_,pUrvapaxa2,_,_,_,_,_,_,_,_,_,_) ->
     ...
     [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
           ...
           | "kim" ->  if id1 = total_wrds.val  (* last word *)
  ...
  | Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyayaH2,_,_,_,pUrvapaxa2,uwwarapaxa2,_,_,_,_) ->
	if (kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="yaw" || kqw_prawyayaH2 = "anIyar" || kqw_prawyayaH2="wavyaw" || kqw_prawyayaH2 = "ac") && (finite_verb_in_sentence.val == 50) (* ac added to account for तस्मात् न अर्हाः वयम् हन्तुम् धार्तराष्ट्रान् स्व-बान्धवान् - relation between na and arhAH which is ac *)
        then match m1 with
        [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
           let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
              if no_boundary_crossing_with_iwi id1 id2 text_type
	...
	if lifgam1 = lifgam3 then
        ...
        match m2 with
             ...
             | Sup (id2,cid2,mid2,word2,_,_,_,_,_,_,_) ->
               let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
               if member_of rt3 manuRyasaFjFAvAcI &&  viBakwiH1 = 6 && (word2 = "nAma") (* wasyA nAma sIwA AsIw *)
               then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id3,cid3,mid3,"39.4a",d13)
                    ;  Relation (id2,cid2,mid2,"karwA",id1,cid1,mid1,"39.5a",d12)
                    ]
               else if  (member_of rt3 jAwivAcaka) || (rt3="praBava") (* ikRvAku vaMSaH praBavaH rAmaH nAma janEH SruwaH *)
                    then if  (word2="nAma" || word2="iwi" (* we can have mArIca nAma rAkRaseNa ... paFca wanwrANi racayiwvA ... tested on mArIcaH nAma rAkRasaH *)
                         ...
                         then if (* id2 < id3 ; This need not be just before the category
                              ...
                              then if id1=previous id2 && (word2="nAma"|| word2="nAmakaH" || word2 = "nAmikA" || word2 = "nAmakam") && viBakwiH1=viBakwiH3
                                   ...
                                   else if word2="iwi" && viBakwiH1=1  && id1=previous id2 && vacanam3="eka" 
                     ...
                     else  if (id1 < id2) && (id2=previous id3) && vacanam3="bahu" && viBakwiH3=1 && viBakwiH1=1 && member_of rt3 saMKyeya
                               then [ Relation (id1,cid1,mid1,"Gataka",id3,cid3,mid3,"39.6",d13)
                                    ;  Relation (id2,cid2,mid2,"Gataka_xyowakaH",id3,cid3,mid3,"39.7",d12)
                                    ]
                              else []
              | _ -> []
              ] else []
...
value rl_saha_vinA_kqwe m1 m2 m3 text_type = match m3 with
  ...
  | Avykqw (id3,cid3,mid3,word3,rt3,_,_,upasarga3,_,_,_,_) -> match m1 with
       ...
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
             match viBakwiH1 with
             [ 3 -> if rt3="gam1" && upasarga3 = "sam_Af" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1a",d13)]
                    else if rt3="gam1" && upasarga3 = "sam" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1b",d13)]
                    else if rt3="yuj2" && word3 = "yukwaH" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1c",d13)]
                    else match m2 with
                [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                    match word2 with
                    [ "saha" | "sAkam" | "sArXam" | "samam"  ->
                         [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.2a",d13)
                         ; Relation (id2,cid2,mid2,"sahArWa_xyowakaH",id1,cid1,mid1,"40.2b",d12)]
		    | "anwareNa" | "vinA" | "nAnA" | "pqWak" | "qwe" ->
                         [ Relation (id1,cid1,mid1,"vinArWaH",id3,cid3,mid3,"40.2c",d13)
                         ; Relation (id2,cid2,mid2,"vinArWa_xyowakaH",id1,cid1,mid1,"40.2d",d12)]
                 ...
                 | Sup (id2,cid2,mid2,word2,rt2,_,_,_,viBakwiH2,_,_) ->
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                     if (word2 = "sahiwaH") then
                         [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.3a",d13)
                         ; Relation (id2,cid2,mid2,"sahArWa_xyowakaH",id1,cid1,mid1,"40.3b",d12)]
		     else []
                 | _ -> []
                ]
              | 2 ->  match m2 with
                  [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
                    let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                           match word2 with
		    [ "miWaH" ->
                         [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.4",d13)
                         ; Relation (id2,cid2,mid2,"sahArWa_xyowakaH",id1,cid1,mid1,"40.5",d12)]
                    | _ -> []
                    ]
                   | _ -> []
                   ]
...
value rlvAkyakarma m1 m2 m3 text_type = match m2 with
      [ Avy (id2,cid2,mid2,word2,_,_,_,_) ->
           ...
           | Sup (id3,cid3,mid3,word3,rt3,_,_,_,_,_,_) -> 
                 if rt3="mawi" || rt3 = "mawa" || rt3 = "nirNaya" || rt3 = "apavAxa" (* loka-apavAxaH *)
                 then match m1 with
                 [ Wif (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_)
...
value sent_beginning_connectives id1 cid1 mid1 id2 cid2 mid2 rt2 upasarga2 word1 text_type =
         let d12 = if id1 > id2 then id1-id2 else id2-id1 in
	      ...
	      if id1=1 &&  word1 = "api" && text_type="Prose"
              ...
              |"prawilomam"
              (*|"awaH"
              |"wawaH" -- covered under discourse relations *)
              |"aWa"
              |"aWakim"
              |"apiwu"
              |"kinwu"
...
value mark_upamAna id1 cid1 mid1 id2 cid2 mid2 word2 id3 cid3 mid3 rl1 rl2 =
         let d12 = if id1 > id2 then id1-id2 else id2-id1 in
         let d23 = if id2 > id3 then id2-id3 else id3-id2 in
         let d13 = if id1 > id3 then id1-id3 else id3-id1 in
         if (d12 > 4) || (d23 > 4) then []  (* the upamAna cannot be far away from the upamAna xyowaka *)
         else if  (id1 < id2) && (id2 < id3)  (* A iva B  / yaWA A B *)
      then  if id2 = next id1 
(* saH aBigawaH saxBiH samuxraH iva sinXuBiH *)
            then 
		 if (word2 = "yaWA") then
                 [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"91a",d13)
                 ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id3,cid3,mid3,"92a",d12)
                 ]
		 else 
                 [ Relation (id1,cid1,mid1,"upamAnam",id3,cid3,mid3,"91",d13)
                 ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id1,cid1,mid1,"92",d12)
                 ]
            else  if id3 = next id2 then
		    if (word2 = "yaWA")
                    then [ Relation (id1,cid1,mid1,"upamAnam",id3,cid3,mid3,"93",d13)
                         ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id1,cid1,mid1,"94",d12)
                         ]
                    else [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"93a",d13)
                         ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id3,cid3,mid3,"94a",d12)
                         ]
     ...
     [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
        ...
        (*| Kqw (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,viBakwiH3,_,_) *)
             ...
             | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,uwwarapaxa1,_,viBakwiH1,_,_) ->  (* saH himavAn iva *)
                   ...
                   then mark_upamAna id1 cid1 mid1 id2 cid2 mid2 word2 id3 cid3 mid3 "50.1" "50.2"
                   else []
        ...
        | Wif (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
	     if (id3 = id2-1) 
             ...
             [ Wif (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_) ->
                   if id2 < id3
                   then mark_upamAna id1 cid1 mid1 id2 cid2 mid2 word2 id3 cid3 mid3 "50.5" "50.6"
                   else []
             | _ -> []
             ]
        (* | Kqw (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
             ...
             [ Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
                   if id2 < id3
                   then mark_upamAna id1 cid1 mid1 id2 cid2 mid2 word2 id3 cid3 mid3 "50.7" "50.8"
                   else []
             | _ -> []
             ] *)
        | _ -> []
           ...
           | WaxXiwa (id3,cid3,mid3,_,rt3,_,_,uwwarapaxa3,_,viBakwiH3,_,_) ->   
               ...
               | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,uwwarapaxa1,_,viBakwiH1,_,_) ->  
                   if viBakwiH3=1  && viBakwiH1=3
                     ...
                     && not ( member_of rt1 saMKyeya || member_of rt1 pUraNa || member_of rt1 kqxanwas || member_of rt1 taddhitaantas || member_of rt1 guNavacana)
                   then mark_upamAna id1 cid1 mid1 id2 cid2 mid2 rt2 id3 cid3 mid3 "50.9" "50.10"
                   else []
               | _ -> []
               ] else []
            | _ -> []
...
(* Example for aWa: तत्र अपश्यत् स्थितान् पार्थः पितॄन् अथ पितामहान् *)
           else if  (word2="aWa") && (id1 = next id2)
           then [ Relation (id1,cid1,mid1,"sup_samucciwaH",id3,cid3,mid3,rl1,d13)
                ; Relation (id2,cid2,mid2,"sup_samuccaya_xyowakaH",id3,cid3,mid3,rl2,d23)
                ]
	   else []
...
value mark_sup_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 viBakwiH1 viBakwiH3 vacanam1 vacanam3 word2 rl1 rl2 =
      let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
           if    viBakwiH1=viBakwiH3 
              && vacanam1=vacanam3
              && id1 < id3 
              && ((id2 = next id3 && word2 = "vA") || (id2 = next id1 && (word2 = "aWavA" || word2 = "uwa" || word2 = "uwasviw")))
           then  [ Relation (id1,cid1,mid1,"sup_anyawaraH",id3,cid3,mid3,rl1, d13)
...
value mark_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 rl1 rl2 =
      let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
           [ Relation (id1,cid1,mid1,"anyawaraH",id3,cid3,mid3,rl1,d13)
...
value rl_anyawara m1 m2 m3 text_type = match m2 with
     [ Avy (id2,cid2,mid2,_,word2,_,_,_) -> 
        if word2 = "vA" || word2 = "aWavA" || word2 = "uwa" || word2 = "uwasviw"
        then match m3 with
        [ Wif (id3,cid3,mid3,_,_,_,_,_,_,prayogaH3,lakAra3,puruRaH3,_,_,_,_) ->
             match m1 with
              [ Wif (id1,cid1,mid1,_,_,_,_,_,_,prayogaH1,lakAra1,puruRaH1,_,_,_,_) ->
...
(* ... gacCawi pATam vA samyak paTawi / gacCawi wiRTawi vA *)
        ...
        | Avykqw (id3,cid3,mid3,_,_,_,_,_,_,kqw3,_,_) ->
             ...
             [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw1,_,_) ->
                 if kqw1=kqw3
                 then mark_sup_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 0 0 0 0 word2 "58.7" "58.8"
                 else []
             | _ -> []
             ]
        ...
        | WaxXiwa (id3,cid3,mid3,_,_,_,_,_,_,viBakwiH3,vacanam3,_) ->  
              ...
              [ Sup(id1,cid1,mid1,word1,rt1,_,_,_,viBakwiH1,vacanam1,_) 
              | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 mark_sup_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 viBakwiH1 viBakwiH3 vacanam1 vacanam3 word2 "58.11" "58.12"
              | _ -> []
              ]
        | Kqw (id3,cid3,mid3,_,_,_,_,kqw3,_,_,_,_,_,_,viBakwiH3,vacanam3,_) ->
              ...
              [ Kqw (id1,cid1,mid1,_,_,_,_,kqw1,_,_,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 if kqw3=kqw1
                 then mark_sup_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3  viBakwiH1 viBakwiH3 vacanam1 vacanam3 word2 "58.15" "58.16"
                 else []
              | Sup(id1,cid1,mid1,word1,rt1,_,_,_,viBakwiH1,vacanam1,_)
              | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 mark_sup_anyawara id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3  viBakwiH1 viBakwiH3 vacanam1 vacanam3 word2 "58.19" "58.20"
              |  _ -> []
              ] 
        | _ -> [] 
        ]
       ...
       | [ m1 :: r1 ] -> 
            ...
            | [ m2 :: r2 ] -> 
                     ...
                     [ [] -> if distinct_2 m1 m2  then
                               (*List.fold_left collate acc2 all_rules2 where --> Amba acc2 -> acc3 26th Dec 2025 *)
                               List.fold_left collate acc3 all_rules2 where
