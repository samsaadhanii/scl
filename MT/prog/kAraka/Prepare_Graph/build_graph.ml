       ...
       [ 1 ->  if aBihiwa rt1 vacanam1 vacanam2 puruRaH2
           ...
           [ "karwari" -> let rel = handle_sp_compounds id1 mid1 id2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
                 ...
                 | _     ->  if not (member_of rt1 intensifiers_list) 
				  ...
				  else  [ Relation (id1,mid1,"karwA",id2,mid2,"2.2b", d)]  
                             else []
		     ...
		     | "gawi"
			     ...
			     if (not (rel=[])) then rel 
		                    ...
		                    then [ Relation (id1,mid1,"prayojyakarwA",id2,mid2,"1.24", d)]  *)
                             ...
                             then  [ Relation (id1,mid1,"prayojyakarwA",id2,mid2,"2.13", d) 
                                   ; Relation (id1,mid1,"karma",id2,mid2,"2.14", d) (* karmaNi xviwIyA *) 
                                   ]
                             else [Relation (id1,mid1,"karma",id2,mid2,"2.15" , d)] 
   ...
   match viBakwiH1 with
                            ...
                            if members_of rt2 upasarga2 karaNa_verbs
                             then if member_of rt1 shabxavAci_nouns || member_of rt1 buxXivAci_nouns
                                  then [ Relation (id1,mid1,"karaNam",id2,mid2,"4.3",d12) ]  (*karwq karaNayoswqwIyA - yAnena gacCawi*) 
                                       ...
                                       then [ Relation (id1,mid1,"karaNam",id2,mid2,"4.6",d12)   (*karwq karaNayoswqwIyA - yAnena gacCawi*) 
                                            ; Relation (id1,mid1,"hewuH",id2,mid2,"4.7",d12) ]
                                       else [ Relation (id1,mid1,"hewuH",id2,mid2,"4.8",d12) ]
       ...
       | 4 ->  if members_of rt2 upasarga2 sampraxAna_verbs
               ...
               then if not (member_of rt1 guNa_not_guNavacana) && not (lifgam1="napuM") 
                then if kqw1=0 
                    then [ Relation (id1,mid1,"sampraxAnam",id2,mid2,"4.12",d12)] (* rajakAya xaxAwi *)
                    else [ Relation (id1,mid1,"prayojanam1",id2,mid2,"4.13",d12)]  
                 else [ Relation (id1,mid1,"prayojanam1",id2,mid2,"4.14",d12)] (* prakRAlanAya xaxAwi *)
...
e.g. saH prAwaH BramaNAya gacCawi -- Amruta   14 July 2020
             *)
                         ...
                         then [ Relation (id1,mid1,"karmasamAnAXikaraNam",id2,mid2,"4.15",d12) ]
                (* manyakarmaNyanAxare viBARAZprANiRu 2-3-17 ahaM wvAM wqNAya manye / aham wvA wqNAya manye *)
                         else if kqw1 = 0
                              then [ Relation (id1,mid1,"prayojanam1",id2,mid2,"4.16",d12)] (* puwrAya puswakaM krINAwi *) 
                              else []
       | 5 -> if members_of rt2 upasarga2 apAxAna_verbs
                    then if pronominal123 rt1
                        then [ Relation (id1,mid1,"apAxAnam",id2,mid2,"4.17",d12)
                             ; Relation (id1,mid1,"hewuH5",id2,mid2,"4.18",d12) ]
                    else if not(member_of rt1 guNa_not_guNavacana) || (kqw1=1)  (* allow kqxanwas also  -- xAwqByaH Xanam laBanwe *)
                         then [ Relation (id1,mid1,"apAxAnam",id2,mid2,"4.19",d12)  (* apAxAne paFcamI  - rAmaH grAmAw AgacCawi / raveH lokaH prakASam aXigacCawi *) 
                              ;  Relation (id1,mid1,"hewuH5",id2,mid2,"4.20",d12)] (* raveH lokaH suKam aXigacCawi *) 
                             else [ Relation (id1,mid1,"hewuH5",id2,mid2,"4.21",d12) ]   (* BayAw nirgacCawi *)
                   else if   rt1="swoka" 
                           || rt1="alpa" 
                           || rt1="kqcCra"
                           || rt1="kawipaya"
                        then [ Relation (id1,mid1,"karaNam",id2,mid2,"4.22",d12)] 
             (* karaNe ca swokAlpakqcCrakawipayasyAsawwvavacanasya 2-3-33 - swokAw mukwaH *)
                        else if (member_of rt1 guNavacana) (* yogyawA *)
                             then [ Relation (id1,mid1,"hewuH5",id2,mid2,"4.23",d12)] (* viBARA guNe aswriyAm 2-3-25 - jAdyAw baxXaH*)  
                             else if (member_of word1 kAlAXvas)
                                  then [ Relation (id1,mid1,"aXikaraNam",id2,mid2,"4.24",d12) ] (* sapwamIpaFcamyO kArakamaXye A 2.3.7 
				          ...
				          && (rt1 = "Asana" || rt1 = "prAsAxa")  (* These are rare constructions, and the condition needs to be stated as if rt1 is a possible aXikaranNa ; This is to avoid marking vacanAw as lyapkarmAXikaraNa for in vacanA xarSayAmAsa *)
                                       then [ Relation (id1,mid1,"lyapkarmAXikaraNam",id2,mid2,"4.25",d12) 
                                            ; Relation (id1,mid1,"hewuH5",id2,mid2,"4.26",d12) ]
                                       else [ Relation (id1,mid1,"hewuH5",id2,mid2,"4.27",d12) ] (* हेतौ पञ्चमी वा स्यादिस्यर्थः।A bAlamanorama tIkA *)
            (* else if word1="wasmAw" || word1="yasmAw"
                 then [ Relation (id1,mid1,"hewuH",id2,mid2,"3.19",d12)]  
	         else [] *)
       | 6 -> if (  rt2="vi_ava_hq1" || rt2="paNa1" || rt2="xiv1")
          then [ Relation (id1,mid1,"karma",id2,mid2,"4.28",d12) ]  
       ...
       | 7  -> if (upasarga2="aXi" && (rt2="SIf1" || rt2="sWA1"))
               then if member_of word1 kAlAXikaraNas (* praBAwe vEkuNTam wiRTawi *)
                    ...
                    then if member_of word1 kAlAXikaraNas (* praBAwe vEkuNTam wiRTawi *)
                         then [ Relation (id1, mid1, "kAlAXikaraNam", id2, mid2,"4.30",d12) ]
                         else if (kqw1 = 0) then [ Relation (id1, mid1, "aXikaraNam", id2, mid2,"4.31",d12) ]
                              else []
 ...
 ... gacCawi ... paTawi; here gacCawi is marked as aXikaraNa. To stop this, again this is uncommented. 26th May 2018 *)
                  then  [ Relation (id1, mid1, (aXikaraNa_type word1 rt1), id2, mid2,"4.32",d12)] 
                  else [] 
               | _ -> if not (rt1="Bavaw"|| rt1="asmax" || rt1 = "yuRmax") then [ Relation (id1, mid1, (aXikaraNa_type word1 rt1), id2, mid2,"4.33",d12) ] 
                      else []
               ]
       | 8 ->  match m2 with
...
if (not (lifgam1="napuM") && kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="ac" || kqw_prawyayaH2="yaw") && (viBakwiH2=1) && id2 = total_wrds.val  *)
               then [ Relation (id1,mid1,"samboXyaH",id2,mid2,"4.35",d12)]
              else []
           |  _ -> []
           ]
       | 2  -> (* covered in rlwifkarwA_karma and rlkqwkarwA_karma *)
           if (member_of rt1 kAlAXvas)
           then [ Relation (id1,mid1,"awyanwasaMyoga_sambanXaH",id2,mid2,"4.36",d12)] (* xevaxawwaH mAsam pATam aXIwe kAlAXvanorawyanwasaMyoge A 2.3.5 *)  (* yogyawA *)
           else if member_of (uwwarapaxa1^" "^string_of_int viBakwiH1) kriyAviSeRaNas (* yogyawA *) && lifgam1="napuM"
           then [ Relation (id1,mid1,"kriyAviSeRaNam",id2,mid2,"4.37",d12)] 
       ...
       then match viBakwiH1 with
        ...
        then match verb_type rt2 upasarga2 with
              ...
              | "sakarmaka" -> if not (sanAxiH2="Nic")
                                        then let rel = handle_sp_compounds id1 mid1 id2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
	                                  if (rel=[]) then 
                                             [ Relation (id1,mid1,"karma",id2,mid2,"5.7" ,d12)] (* karmaNi xviwIyA *) 
					  else []
  ...
  | Kqw (id2,mid2,word2,_,_,_,_,_,_,_,rt2,_,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) -> 
   ...
   match m1 with
      [ Sup (id1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
           (* let rel = handle_sp_compounds id1 mid1 id2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
           if not (rel = []) then rel 
           else  -- a relation which is between a sup and a wif *) 
           let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
      ...
      *)
     | WaxXiwa (id1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) -> if (member_of rt1 upAXi) then [] else
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       if prose_order id1 id2 text_type
       && not (finite_verb_in_sentence.val = 50 && karwqsamverbs.val = 50)
            && no_boundary_crossing_except_kwvA id1 id2 text_type
...
value discourse_rel1 m1 id2 mid2 text_type = match m1 with
     [ Avy (id1,mid1,word1,_,_,_,_) -> 
       ...
       | "awaH" -> if (id1 < id2)
          ...
          else [ Relation (id1,mid1,"sambanXaH",id2,mid2,"37.3",d12)]
       (*| "yaxi" 
       | "cew" -> if (id1 < id2)
...
value rl_saha_vinA_kqwe m1 m2 m3 text_type = match m3 with
  [ Wif (id3,mid3,_,rt2,_,_,upasarga2,_,_,_,_,_,_,_,_,_)
  | Kqw (id3,mid3,_,rt2,upasarga2,_,_,_,_,_,_,_,_,_,_,_,_)
  | Avykqw (id3,mid3,_,rt2,_,_,upasarga2,_,_,_,_,_) -> match m1 with
       ...
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
             match viBakwiH1 with
             [ 3 -> if rt2="gam1" && upasarga2 = "sam_Af" then [ Relation (id1,mid1,"sahArWaH",id3,mid3,"40.1",d13)]
                    else match m2 with
                [ Avy (id2,mid2,word2,_,_,_,_) -> 
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                    match word2 with
                    [ "saha" | "sAkam" | "sArXam" | "samam" | "sahiwaH" ->
                         [ Relation (id1,mid1,"sahArWaH",id3,mid3,"40.2",d13)
                         ; Relation (id2,mid2,"sahArWa_xyowakaH",id1,mid1,"40.3",d12)]
		    | "anwareNa" | "vinA" | "nAnA" | "pqWak" | "qwe" ->
                         [ Relation (id1,mid1,"vinArWaH",id3,mid3,"40.4",d13)
                         ; Relation (id2,mid2,"vinArWa_xyowakaH",id1,mid1,"40.5",d12)]
              ...
              | 5 ->  match m2 with
                  [ Avy (id2,mid2,word2,_,_,_,_) -> 
                    let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                           match word2 with
		    [ "qwe" ->
                         [ Relation (id1,mid1,"vinArWaH",id3,mid3,"40.6",d13)
                         ; Relation (id2,mid2,"vinArWa_xyowakaH",id1,mid1,"40.7",d12)]
                    | _ -> []
                    ]
                   | _ -> []
                   ]
       ...
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
              match word2 with
                      ["kqwe" ->
                         [ Relation (id1,mid1,"prayojanam",id3,mid3,"40.8",d13)
                         ; Relation (id2,mid2,"prayojanam_xyowakaH",id1,mid1,"40.9",d12)]
                      | _ -> []
                      ]
                    | _ -> []
                    ]
...
value rlBAvalakRaNa_sapwamI2 m1 m2 text_type = match m2 with
    [ Kqw (id2,mid2,_,rt2,upasarga2,_,kqw2,_,_,_,_,_,_,_,viBakwiH2,_,_) ->
     ...
     then if viBakwiH1=viBakwiH2 
          ...
          then [ Relation (id1,mid1,"BkarwA",id2,mid2,"44.1",d12) 
              ]
          else if viBakwiH1=2 && viBakwiH2=7
                   && (kqw2="kwa" || kqw2="kwavawu")
                   && not ((verb_type rt2 upasarga2) = "akarmaka")
               then [ Relation (id1,mid1,"Bkarma",id2,mid2,"44.2",d12) ]
               else []
     else []
       | _ -> []
       ]
     ...
     [ Avy (id2,mid2,word2,_,_,_,_) -> 
        ...
        | WaxXiwa (id3,mid3,_,_,_,_,_,_,viBakwiH3,_,_) -> 
             ...
             | Kqw (id1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_) ->
                   ...
                   then [ Relation (id2,mid2,"uwprekRA_xyowakaH",id1,mid1,"50.3",1)]
                   else []
             | _ -> []
             ]
        | Wif (id3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
...
value dis_rel_pair id1 mid1 id3 mid3 id2 mid2 word2 =
    let d13 = if id1 > id3 then id1-id3 else id3-id1 in
     ...
     | "wawaH" -> if not (id2 = 1 && yawaH_pos.val = 50) then 
                   [ Relation (id3,mid3,"kArya_kAraNa_BAvaH",id1,mid1,"57.8",d13)
...
value dis_rel_pair2 m1 id2 mid2 id3 mid3 word2 tense3 = match m1 with
    [ Wif (id1,mid1,_,_,_,_,_,_,_,lat1,_,_,_,_,_,_) ->
...
value rl_wif_kriyA_kriyA m1 m2 m3 text_type = match m2 with
     [ Avy (id2,mid2,_,word2,_,_,_) -> 
        ...
        then match m3 with
        [ Wif (id3,mid3,_,_,_,_,_,_,_,lat3,_,_,_,_,_,_) ->
	   dis_rel_pair2 m1 id2 mid2 id3 mid3 word2 lat3
        | Kqw (id3,mid3,_,_,_,_,kqw3,_,_,_,_,_,_,_,_,_,_) ->
           if(kqw3 = "kwa" || kqw3 = "kwavawu") && not (word2="waxA")
	   then dis_rel_pair2 m1 id2 mid2 id3 mid3 word2 kqw3
           else []
        | _ -> []
        ]
        else []
