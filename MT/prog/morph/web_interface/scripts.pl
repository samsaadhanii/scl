...
function generate_any_noun_forms(encod,prAwi,lifga,jAwi,outencoding,level){
  window.open('/cgi-bin/scl/skt_gen/noun/noun_gen_web.cgi?encoding='+encod+'&rt='+prAwi+'&gen='+lifga+'&jAwi='+jAwi+'&outencoding='+outencoding+'&level='+level+'','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes').focus();
}

function generate_noun_forms(encod,prAwi,lifga){
 window.open('/cgi-bin/scl/amarakosha/noun_gen.cgi?encoding='+encod+'&rt='+prAwi+'&gen='+lifga+'&jAwi=nA'+'&outencoding='+outencoding+'&level=1'+'','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes').focus();
}
...
function generate_verb_forms(encod,outencoding,rt,prayoga,upasarga,paxI){
  window.open('/cgi-bin/scl/skt_gen/verb/verb_gen_web.cgi?encoding='+encod+'&outencoding='+outencoding+'&vb='+rt+'&prayoga_paxI='+prayoga+'-'+paxI+'&upasarga='+upasarga+'','popUpWindow','height=500,width=800,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes').focus();
}\n
